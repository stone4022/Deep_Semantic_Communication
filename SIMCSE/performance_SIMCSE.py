...
from utils import BleuScore, SNR_to_noise, test_simcse2fc
...
parser.add_argument('--checkpoint-path', default='../checkpoints/SIMCSE2FC/lr=1e-5/', type=str)
        ...
        for epoch in range(args.Test_epochs):
            ...
            for snr in SNR:
                ...
                for sents in test_iterator:
                    ...
                    out = test_simcse2fc(net, sents, noise_std, args.MAX_LENGTH, pad_idx, start_idx, args.channel)
...
if __name__ == '__main__':
    ...
    bleu_score1, bleu_score2, bleu_score3, bleu_score4 = performance(args, SNR, deepsc_simcse2fc, pad_idx, start_idx, end_idx)
    print(bleu_score1)
    print(bleu_score2)
    print(bleu_score3)
    print(bleu_score4)
